...
// ESP-IDF: CONFIG_* macros (including CONFIG_IDF_TARGET_*) come from
// sdkconfig.h
#include "sdkconfig.h"
#endif
...
#if ESP_IDF_VERSION >= ESP_IDF_VERSION_VAL(5, 2, 1)
  // Avoid -Wmissing-field-initializers when IDF extends this struct (e.g.
  // sc_en) while still setting the one field we care about.
